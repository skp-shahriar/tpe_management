...
<div class="box">
    <form class="login-form" method="POST" action="{{ route('login') }}">
        @csrf
        <h1>Login</h1>
        <input id="email" type="email" placeholder="Enter Your E-mail" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
        ...
        <input type="submit" class="btn btn-success m-2 px-4" name="Login" value="Login">
        <div class="links">
            @if (Route::has('password.request'))
            <div class="d-block">
